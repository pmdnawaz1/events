...
export default function Cards() {
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-md mx-auto text-center">
            <h2 className="text-2xl font-bold text-yellow-900 sm:text-3xl">Our featured Events</h2>
        ...
        <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4">
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <img className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src="https://cdn.britannica.com/38/95238-050-C1D9D0F2/Children-Kolkata-Holi-festival-Hindu.jpg" alt="" />
                </div>
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">RS99.00</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative group">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">RS299.00</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative group">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">RS49.00</p>
                        <del className="mt-0.5 text-xs sm:text-sm font-bold text-gray-500"> RS99.00 </del>
                    </div>
                </div>
            </div>
            ...
            <div className="relative group">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">RS79.00</p>
                    </div>
                </div>
            </div>
        </div>
